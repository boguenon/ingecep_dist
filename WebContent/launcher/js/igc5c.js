...
/* for inner panel*/
	...
	_IFe/*initF*/: function() {
		...
		if (me._ILa/*reportoption*/ && me._ILb/*sheetoption*/)
		{
			...
			var grd_seriestype = me.down("[name=grid_seriestype]"),
				seriestype = [],
				obj,
				n = Math.max(5, me._ILb/*sheetoption*/.measures.length);
				
			for (i=0; i < n; i++)
			{
				obj = {};
				obj.index = (i+1);
				obj.name = (me._ILb/*sheetoption*/.measures.length > i) ? me._ILb/*sheetoption*/.measures[i].name : "";
										...
										},
										{
											...
											items: [
												...
												},
												{
											    	...
											    	store: {
														fields: [
															"name", "seriestype", "y2axis", "dl_marker", "dl_enable"
														]
													},
											    	height: 120,
											    	//plugins: [cellEditing],
