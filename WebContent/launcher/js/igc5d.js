...
IG$/*mainapp*/._IEc/*clChartOption*/ = function(node) {
	...
	me.__pca = [
		"animate;drillyaxismax;enabledrill;enablezoom;enabledragselect;legendboxsizing;matshowgrid;matshowplot;matusedropshadow;showlegend;lgndfloating;showtitle;stack;stackperc;usedualaxis;renderbymeasures;useformula;swapaxis;bmaprow;bmapyaxis;dl_enable;dl_marker;dl_linetype;dl_inside;useformatvalue;showvalue;tm_l_alg;xlabel;xaxisrot",
		"chartprovider;charttype;legendposition;subtype;title;titleposition;tooltip;yvalueformat;zoomdirection;drillcharttype;andersonspecies;relationgroups;renderas;dualaxisitem;dl_marker_l;dl_linetype_l;dl_enable_l;maptype;mapcategory;yaxisformat;yaxismin;yaxismax;nat_timefield;nat_datafield;nat_groupfield;nat_xdata;nat_ydata;nat_vdata;timeseriesfield;bmapsizeaxisfield;bmapyaxisfield;colorset;yaxisformat2;yaxismin2;yaxismax2;pielayout;yaxistitle;yaxistitle2;dl_align;tm_l_cl;chd_method",
	...
	if (node)
	{
		...
		var drillcharttype = me.drillcharttype,
			...
			dl_linetype_l = me.dl_linetype_l,
		...
		me.dl_linetype_l = dl_linetype_l && dl_linetype_l.split ? dl_linetype_l.split(";") : [];
...
IG$/*mainapp*/._IEc/*clChartOption*/.prototype = {
	TX/*getXML*/: function() {
		...
		me.dl_linetype_l = dl_linetype_l && dl_linetype_l.length ? dl_linetype_l.join(";") : null;
		...
		dl_linetype_l = me.dl_linetype_l;
		me.dl_linetype_l = dl_linetype_l ? dl_linetype_l.split(";") : [];
		dl_enable_l = me.dl_enable_l;
...
IG$/*mainapp*/._IF8/*clReportItemStyle*/ = function(node, nodename) {
	var me = this;
	me.objinfo = "name;backcolor;bordercolor;forecolor;formatstring;fontsize;nullvalue;fontstyle;paddingbottom;paddingleft;paddingright;paddingtop;textalign;width;widthmode;borderbottom;borderright;bordertop;borderleft;borderoutbottom;borderoutright;borderouttop;borderoutleft;columnwidth;autowidth;cssname";
	me.nodename = nodename;
	
	me.__pca = [
		"name;backcolor;bordercolor;forecolor;fontsize;nullvalue;autowidth;cssname",
		"fontstyle;paddingbottom;paddingleft;paddingright;paddingtop;textalign;width;widthmode;borderright;borderbottom;borderleft;bordertop;borderoutright;borderoutbottom;borderoutleft;borderouttop;columnwidth"
	];
...
IG$/*mainapp*/._IF9/*clStyle*/ = function(node, baddcss) {
	...
	IG$/*mainapp*/._I1f/*XGetInfo*/(me, node, "name;nullvalue;fontsize;gradient;backcolor1;backcolor2;str_backcolor1;str_backcolor2;backalpha1;backalpha2;bordercolor;borderthickness;padleft;padright;padtop;padbottom;textalign;fontstyle;color;fontsize;borderbottom;borderright;borderleft;bordertop;borderoutbottom;borderoutright;borderoutleft;borderouttop;columnwidth;autowidth;cssname", "s");
	IG$/*mainapp*/._I1fx/*XGetInfo*/(me, node, "formatstring");
	IG$/*mainapp*/._I1fx/*XGetInfo*/(me, node, "template");
	...
	dor/*drawOlapResult*/: function (ispageview, _is_sc, _hcell, cresult) {
		...
		if (me.mresult != null && me.mresult.data != null && me.mresult.data.length > 0)
		{
			...
			else
			{
				...
				// me.mresult.colfix += showlnum ? 1 : 0;
...
//						};
		...
		else
		{
			...
			{
				mseq = (mcr.renderbymeasures ? series[i].meas_k : i);
				
				if (!bfixedp)
				{
					if (mseq > -1 && mcr.renderas && mcr.renderas.length > mseq && mcr.renderas[mseq])
					{
						series[i].type = IG$/*mainapp*/._I36/*getSeriesType*/(mcr.renderas[mseq]);
					}
				}
				
				if (mseq > -1 && mcr.dl_enable_l && mcr.dl_enable_l.length > mseq)
				{
					if (mcr.dl_enable_l[mseq] == "F")
					{
					...
					else if (mcr.dl_enable_l[mseq] == "T")
					{
						if (!series[i].dataLabels)
						{
							series[i].dataLabels = {
				...
				if (mseq > -1 && mcr.dl_marker_l && mcr.dl_marker_l.length > mseq)
				{
					if (mcr.dl_marker_l[mseq] == "F")
					{
						if (series[i].marker)
						{
							series[i].marker = {
					...
					else if (mcr.dl_marker_l[mseq] == "T")
					{
						if (!series[i].marker)
						{
							series[i].marker = {
				...
				if (mseq > -1 && mcr.dl_linetype_l && mcr.dl_linetype_l.length > mseq && mcr.dl_linetype_l[mseq])
				{
					series[i].dashStyle = me.getDashStyle(mcr.dl_linetype_l[mseq]);
				}
			...
			if (mcr.usedualaxis == true && mcr.dualaxisitem && mcr.dualaxisitem.length > -1 && series.length > 1)
			{
				for (i=0; i < series.length; i++)
				{
					...
					if (mcr.dualaxisitem.length > mseq && mcr.dualaxisitem[mseq] == "T")
					{
						hasdualaxis = true;
						break;
					}
				...
				if (hasdualaxis == true)
				{
					...
					for (i=0; i < series.length; i++)
					{
						...
						if (mseq > -1 && mcr.dualaxisitem.length > mseq && mcr.dualaxisitem[mseq] == "T")
						{
							series[i].yAxis = 1;
						}
					}
