IG$/*mainapp*/.__c_/*chartoption*/.chartext.sankey.prototype.buildNode = function(results, snode) {
...
IG$/*mainapp*/.__c_/*chartoption*/.chartext.sankey.prototype.drawChart = function(owner, results) {
...
//			.attr("transform", "translate(" + margin.left + "," + margin.top + ")");
	...
	link.append("title")
		.text(function(d) { return d.source.name + " ¡æ " + d.target.name + "\n" + format(d.value); });
