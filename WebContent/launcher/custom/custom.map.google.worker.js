IG$/*mainapp*/.__c_/*chartoption*/.chartext.googlemap.prototype.google_initialize = function(container) {
	var me = this,
		mapOptions = {
		zoom: 8,
...
IG$/*mainapp*/.__c_/*chartoption*/.chartext.googlemap.prototype.validateData = function() {
	var me = this;
...
IG$/*mainapp*/.__c_/*chartoption*/.chartext.googlemap.prototype.updateData = function() {
	var me = this,
		map = me.map_inst,
		bnd = map.getBounds(),
	...
	if (bnd && ne)
	{
		...
		me.req_cnt = 0;
		owner.__r1/*requestData*/.call(owner, bopt);
	}
	else
	{
		if (me.req_cnt < 5)
...
IG$/*mainapp*/.__c_/*chartoption*/.chartext.googlemap.prototype.drawChart = function(owner, results) {
...
IG$/*mainapp*/.__c_/*chartoption*/.chartext.googlemap.prototype.setData = function(owner, results) {
	var me = this,
...
IG$/*mainapp*/.__c_/*chartoption*/.chartext.googlemap.prototype.updatedisplay = function(owner, w, h) {
	var me = this,
		map = me.map;
