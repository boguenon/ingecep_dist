IG$/*mainapp*/.__c_/*chartoption*/.chartext.esri.prototype.map_initialize = function(container) {
	var me = this,
		esri = me.esri,
		map,
		mapOptions = {
...
IG$/*mainapp*/.__c_/*chartoption*/.chartext.esri.prototype.validateData = function(extent) {
	var me = this;
...
IG$/*mainapp*/.__c_/*chartoption*/.chartext.esri.prototype.updateData = function() {
	var me = this,
		map = me.map_inst,
		extent = map.extent,
		zoom = map.getZoom(),
...
IG$/*mainapp*/.__c_/*chartoption*/.chartext.esri.prototype.drawChart = function(owner, results) {
...
IG$/*mainapp*/.__c_/*chartoption*/.chartext.esri.prototype.setData = function(owner, results) {
	var me = this,
		esri = me.esri,
	...
	$.each(results.geodata, function(i, p) {
		...
		if (cop.m_marker == "circle")
		{
			...
			var graphic = new esri.Graphic(marker, symbol);
				...
				g.on("click", function(evt) {
					...
					for (i=0; i < p.data.length; i++)
					{
						...
						if (i >= colfix)
						{
							for (j=0; j < rowfix; j++)
							{
								ct = (j == 0) ? results.data[j][i].text : ct + "|" + results.data[j][i].text;
							}
...
IG$/*mainapp*/.__c_/*chartoption*/.chartext.esri.prototype.updatedisplay = function(owner, w, h) {
	var me = this,
		map = me.map_inst;
