...
IG$/*mainapp*/.__c_/*chartoption*/.chartext.hstock.prototype.drawChart = function(owner, results) {
	var me = this,
	...
	if (results)
	{
		...
		for (i=0; i < series.length; i++)
		{
			...
			{
				series[i].type = IG$/*mainapp*/._I36/*getSeriesType*/(cop.renderas[i]);
			}
		}
		...
		me.hchart = new Highcharts.StockChart(copt);
	}
};
	
IG$/*mainapp*/.__c_/*chartoption*/.chartext.hstock.prototype.updatedisplay = function(owner, w, h) {
	var me = this;
