...
<%
    ...
    {
    	mts = com.mplix.rpc.igcRpc.LoadMTS(uri);
    }
%>
<!DOCTYPE html>
<html>
  <head>
    ...
    <link rel="stylesheet" href="./main/css/maia.css" />
    <link rel="stylesheet" href="./main/css/mainpage.css" />
<!--[if lt IE 9]>
...
<![endif]-->
	...
	<script type="text/javascript" src="./launcher/js/browser.min.js"></script>
    <script type="text/javascript">
    var __mts_id = "<%=(mts == null ? "" : mts)%>";
   	</script>
	            ...
	            <div class="maia-locales">
	                <label>
	                    <select id="b_loc">
	                        ...
	                        <option selected="" value="ko_KR">Korean</option>
	                    </select>
	                </label>
	            </div>
	            <ul>
	                <li>
	                    <a href="/">&copy; AMPLIX All rights reserved.</a>
	                </li>
	                <li>
